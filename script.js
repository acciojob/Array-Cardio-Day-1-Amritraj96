...
export function sortbylived() {
    return [...inventors].sort((a, b) => {
        ...
        return nextGuy - lastGuy; // Descending order: longest lived first
    });
}
...
export function reducedSum() {
    // Return an object containing transports as key and its number of occurrences as the key's value
